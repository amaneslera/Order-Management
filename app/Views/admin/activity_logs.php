        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar p-0">
                ...
                <nav class="nav flex-column">
                    ...
                    <a href="/admin/menu" class="nav-link"><i class="bi bi-cup-hot me-2"></i>Menu Items</a>
                    <a href="/admin/users" class="nav-link"><i class="bi bi-people me-2"></i>Users</a>
                    <a href="/admin/activity-logs" class="nav-link active"><i class="bi bi-activity me-2"></i>Activity Logs</a>
